  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add/Editar usuário <i class="fa fa-user-circle-o"
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <div class="input-group mb-3">
              ...
              <input type="phone" class="form-control" id="phone" name="phone" required="required" maxLength="11"
                minLength="10">
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="input-group mb-3">
              ...
              <div class="custom-file">
                ...
                <label class="custom-file-label" for="userphoto">Escolha uma foto</label>
              </div>
            </div>
          </div>
        </div>
